...
/// +--------+      |                  |
///                 +------------------+
pub(crate) fn blit(tex_pixels: uvec2, tex_pos: uvec2, sprite_pixels: uvec2, scrn_pixels: uvec2, scrn_pos: uvec2, scale: u32) -> MeshBuffer {
	...
	let dst_x1 = linterp(0.0, -1.0, scrn_pixels.x(), 1.0, scrn_pos.x() + scale * sprite_pixels.x());
	let dst_y1 = linterp(0.0, 1.0, scrn_pixels.y(), -1.0, scrn_pos.y() + scale * sprite_pixels.y());
