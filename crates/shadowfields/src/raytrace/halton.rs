// TODO: Sobol-Burley http://extremelearning.com.au/unreasonable-effectiveness-of-quasirandom-sequences/
...
pub fn halton35(i: u32) -> (f32, f32) {
	(halton(3, i), halton(5, i))
}

pub fn halton25(i: u32) -> (f32, f32) {
	(halton(2, i), halton(5, i))
}
...
pub fn halton57_scrambled(i: u32, rand: (f32, f32)) -> (f32, f32) {
	let (u, v) = (halton(5, i), halton(7, i));
	((u + rand.0) % 1.0, (v + rand.1) % 1.0)
}
